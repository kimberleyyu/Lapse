...
#import "GAKAppDelegate.h"

#import "GAKOverlayViewController.h"

@implementation GAKAppDelegate
{
    UIImagePickerController *_pickerController;
    GAKOverlayViewController *_overlayController;
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _overlayController = [[GAKOverlayViewController alloc] initWithNibName:nil bundle:nil];
